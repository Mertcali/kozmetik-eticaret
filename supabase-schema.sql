...
INSERT INTO products (
    ...
    category_id, image_url, sku, stock_quantity, is_featured, rating, review_count
)
SELECT 
    'Kablosuz Kulaklık', 'kablosuz-kulaklik', 
    ...
    1299.99, 1499.99,
    id, 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800',
...
SELECT 
    ...
    2499.99, 2999.99,
    id, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800',
...
SELECT 
    ...
    'Premium deri ceket',
    899.99, 1199.99,
    id, 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800',
...
SELECT 
    ...
    649.99, 799.99,
    id, 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800',
    'SA-4000', 100, true, 4.8, 342
FROM categories WHERE slug = 'spor-outdoor'
UNION ALL
SELECT 
    ...
    'LED masa lambası',
    299.99, 399.99,
    id, 'https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=800',
...
SELECT 
    ...
    199.99, 249.99,
    id, 'https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=800',
